...
export default function AffiliatesPage() {
  ...
  async function handleFreeAccessCheck() {
    ...
    try {
      ...
      const data = await res.json()
      setFreeAccessResult(data.message || (data.ok ? 'Program B access check complete.' : 'Check complete.'))
      fetchAffiliates()
    } catch {
        ...
        <div className="flex items-center justify-between gap-4 flex-wrap">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-0.5">Manage partners, partner-assisted clients, and compensation payouts</p>
            </div>
          </div>
