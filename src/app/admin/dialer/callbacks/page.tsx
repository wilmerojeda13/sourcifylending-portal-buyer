    ...
    <div className="min-h-screen bg-gray-950">
      ...
      <div className="bg-gray-900 border-b border-gray-800">
        <div className="max-w-7xl mx-auto px-4 py-4 sm:px-6">
          <h1 className="text-xl font-bold text-gray-100">Callbacks</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 py-6 sm:px-6">
        {dueCallbacks.length === 0 && upcomingCallbacks.length === 0 ? (
          <div className="bg-gray-900 rounded-xl border border-gray-800 p-12 text-center">
            ...
            <h3 className="font-semibold text-gray-100 mb-1">No callbacks scheduled</h3>
            <p className="text-sm text-gray-400">Set callbacks when dispositoning leads to schedule follow-ups.</p>
          </div>
        ) : (
              ...
              <div>
                ...
                <div className="grid gap-3">
                  {dueCallbacks.map(lead => (
                    <div key={lead.id} className="bg-gray-900 rounded-xl border border-red-800/60 p-4 flex items-center justify-between">
                      <div>
              ...
              <div>
                ...
                <div className="grid gap-3">
                  {upcomingCallbacks.map(lead => (
                    <div key={lead.id} className="bg-gray-900 rounded-xl border border-gray-800 p-4 flex items-center justify-between opacity-75">
                      <div>
                        <p className="font-medium text-gray-100">{lead.first_name} {lead.last_name}</p>
                        <p className="text-sm text-gray-400">{lead.phone}</p>
