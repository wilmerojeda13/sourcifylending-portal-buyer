...
const ARNOLD_TASKS = [
  ...
  { task_id: '00000001-migr-4000-8001-000000000011', user_id: ARNOLD_ID, program: 'program_b', stage: 'Bureau Setup', title: 'Confirm whether a D-U-N-S number exists — if not, request one', description: 'Check if Jungle Master Trucking LLC already has a D-U-N-S number. If not, initiate registration at dnb.com. Use exact legal name and address consistently across all bureau and vendor setups.', status: 'in_progress', completed_at: null, sort_order: 11, requires_document: false, due_date: '2026-03-19' },
  { task_id: '00000001-migr-4000-8001-000000000012', user_id: ARNOLD_ID, program: 'program_b', stage: 'Bureau Setup', title: 'Client to create Experian Business account', description: 'Have client set up their Experian Business profile. Use exact legal name + address for consistency.', status: 'in_progress', completed_at: null, sort_order: 12, requires_document: false, due_date: '2026-03-19' },
  { task_id: '00000001-migr-4000-8001-000000000013', user_id: ARNOLD_ID, program: 'program_b', stage: 'Bureau Setup', title: 'Client to create Nav account', description: 'Have client set up their Nav business credit monitoring account. Use exact legal name + address.', status: 'in_progress', completed_at: null, sort_order: 13, requires_document: false, due_date: '2026-03-19' },
