// /go/[slug] — tracked redirect route (mirrors /api/go/[slug])
// Links throughout the portal use /go/ prefix; this handler resolves them.
...
export async function GET(
  ...
  try {
    ...
    const source = req.nextUrl.searchParams.get('source') ?? 'portal_link'
