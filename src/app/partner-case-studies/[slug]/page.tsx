...
export async function generateMetadata({ params }: { params: { slug: string } }) {
  const page = await getPublishedContentPage('partner-case-studies', params.slug)
  return page ? buildPageMetadata(page) : {}
}

export default async function PartnerCaseStudyContentPage({ params }: { params: { slug: string } }) {
  const page = await getPublishedContentPage('partner-case-studies', params.slug)
  if (!page) notFound()
