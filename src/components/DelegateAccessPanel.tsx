    ...
    return (
      <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-50 dark:border-gray-700 flex items-center gap-2">
          ...
          <h2 className="text-sm font-semibold text-gray-900 dark:text-white">Assistant Access</h2>
        </div>
    ...
    return (
      <div className="bg-white dark:bg-gray-800 rounded-2xl border border-blue-100 dark:border-blue-800 shadow-sm overflow-hidden">
        <div className="px-6 py-4 border-b border-blue-50 dark:border-blue-800 flex items-center gap-2 bg-blue-50/40 dark:bg-blue-900/20">
          ...
          <h2 className="text-sm font-semibold text-blue-900 dark:text-blue-300">Delegate Access</h2>
          <span className="ml-auto text-[10px] font-bold px-2 py-0.5 bg-blue-100 dark:bg-blue-900/40 text-blue-700 dark:text-blue-300 rounded-full uppercase">Delegate</span>
        </div>
        <div className="p-6">
          ...
          <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-4">
            <p className="text-xs text-gray-500 dark:text-gray-400 mb-1 uppercase tracking-wide font-semibold">Account Owner</p>
          ...
          <div className="mt-3 bg-amber-50 dark:bg-amber-900/30 border border-amber-100 dark:border-amber-800 rounded-xl p-3">
            <p className="text-xs text-amber-700 dark:text-amber-400">Billing and subscription management are restricted to the account owner.</p>
          </div>
        </div>
      </div>
    )
    ...
    <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm overflow-hidden">
      ...
      <div className="p-6 space-y-4">
        ...
        <div className="space-y-2">
          <p className="text-xs text-gray-400 dark:text-gray-500 uppercase tracking-wide font-semibold">Account Users</p>
