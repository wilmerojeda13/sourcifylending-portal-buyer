    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden">
        <div className="px-5 py-4 border-b border-gray-100 dark:border-gray-700 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-sm text-gray-800 dark:text-gray-200">Billing Overview</span>
          </div>
        ...
        <div className="p-5 grid grid-cols-2 md:grid-cols-3 gap-4">
          ...
          <div className="col-span-2 md:col-span-3">
            <p className="text-xs text-gray-500 dark:text-gray-400 mb-1.5">Active Programs</p>
          ...
          {/* Access Status */}
          <div>
            <p className="text-xs text-gray-500 dark:text-gray-400 mb-0.5">Portal Access</p>
          ...
          {/* Billing Status */}
          <div>
            <p className="text-xs text-gray-500 dark:text-gray-400 mb-0.5">Billing Status</p>
          ...
          {/* Activation Source */}
          <div>
            <p className="text-xs text-gray-500 dark:text-gray-400 mb-0.5">Activated By</p>
          ...
          {/* Monthly Fee */}
          <div>
            <p className="text-xs text-gray-500 dark:text-gray-400 mb-0.5">Monthly Fee</p>
            <p className="text-sm text-gray-700 dark:text-gray-300">{fmt(program_info?.monthlyFee ?? subscription?.monthly_fee_standard)}/mo</p>
          </div>

          {/* Total Paid */}
          <div>
            <p className="text-xs text-gray-500 dark:text-gray-400 mb-0.5">Total Paid (logged)</p>
          ...
          {setupStandard > 0 && (
            <div>
              <p className="text-xs text-gray-500 dark:text-gray-400 mb-0.5">Setup Balance Due</p>
        ...
        {arrangement && arrangement.next_amount_due && (
          <div className="mx-5 mb-4 px-4 py-3 bg-purple-50 dark:bg-purple-900/30 border border-purple-200 dark:border-purple-800 rounded-lg">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-xs font-semibold text-purple-800 dark:text-purple-300">Next Payment Due</span>
            </div>
            ...
            {arrangement.next_due_date && (
              <p className="text-xs text-purple-700 dark:text-purple-400">Due: {new Date(arrangement.next_due_date).toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}</p>
            )}
          </div>
        )}
        ...
        {subscription?.admin_billing_notes && (
          <div className="mx-5 mb-4 px-4 py-3 bg-yellow-50 dark:bg-yellow-900/30 border border-yellow-200 dark:border-yellow-800 rounded-lg">
            <p className="text-xs font-semibold text-yellow-800 dark:text-yellow-300 mb-1">Internal Notes</p>
      ...
      <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden">
        <div className="px-5 py-4 border-b border-gray-100 dark:border-gray-700 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-sm text-gray-800 dark:text-gray-200">Membership Management</span>
          </div>
        ...
        <div className="p-5 space-y-4">
          <p className="text-xs text-gray-500 dark:text-gray-400">Add or remove program enrollments. A client can be enrolled in multiple programs simultaneously (e.g. A + B, or any program + C).</p>
              ...
              return (
                <div key={code} className={`rounded-xl border p-4 flex flex-col gap-3 transition-all ${active ? 'border-green-200 dark:border-green-800 bg-green-50 dark:bg-green-900/20' : 'border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-700/50'}`}>
                  <div className="flex items-start justify-between gap-2">
                    ...
                    {active
                      ? <span className="flex items-center gap-1 text-[11px] font-semibold text-green-700 dark:text-green-400 bg-green-100 dark:bg-green-900/40 px-2 py-0.5 rounded-full shrink-0"><CheckCircle className="w-3 h-3" /> Active</span>
                      : <span className="text-[11px] font-semibold text-gray-400 dark:text-gray-500 bg-gray-100 dark:bg-gray-700 px-2 py-0.5 rounded-full shrink-0">Inactive</span>
                    }
                  </div>
                  {active ? (
      ...
      <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden">
        <div className="px-5 py-4 border-b border-gray-100">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-sm text-gray-800 dark:text-gray-200">Manual Access Control</span>
          </div>
        </div>
        ...
        {showArrangementForm && (
          <div className="p-5 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="block text-xs text-gray-600 dark:text-gray-400 mb-1">Setup Fee Total ($)</label>
              ...
              <div>
                <label className="block text-xs text-gray-600 dark:text-gray-400 mb-1">Setup Fee Paid So Far ($)</label>
              ...
              <div>
                <label className="block text-xs text-gray-600 dark:text-gray-400 mb-1">Monthly Recurring ($)</label>
              ...
              <div>
                <label className="block text-xs text-gray-600 dark:text-gray-400 mb-1">Next Amount Due ($)</label>
              ...
              <div>
                <label className="block text-xs text-gray-600 dark:text-gray-400 mb-1">Next Due Date</label>
            ...
            <div>
              <label className="block text-xs text-gray-600 dark:text-gray-400 mb-1">Internal Notes (admin only)</label>
      ...
      <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden">
        <div className="px-5 py-4 border-b border-gray-100 dark:border-gray-700 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <DollarSign className="w-4 h-4 text-gray-500 dark:text-gray-400" />
            <span className="font-semibold text-sm text-gray-800 dark:text-gray-200">Payment Records</span>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="col-span-2">
                ...
                <input type="text" value={payForm.notes} onChange={e => setPayForm(f => ({ ...f, notes: e.target.value }))}
                  className="w-full bg-white dark:bg-gray-700 text-gray-900 dark:text-white border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-500" placeholder="e.g. Deposit collected at close" />
              </div>
              <div className="col-span-2">
                <label className="block text-xs text-gray-600 dark:text-gray-400 mb-1">Stripe Invoice ID (optional)</label>
      ...
      <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden">
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-sm text-gray-800 dark:text-gray-200">Stripe Actions</span>
          </div>
        ...
        {showStripePanel && (
          <div className="p-5 space-y-4">
            ...
            {stripeForm.action === 'attach_customer' && (
              <div>
                <label className="block text-xs text-gray-600 dark:text-gray-400 mb-1">Stripe Customer ID</label>
            ...
            {stripeForm.action === 'attach_subscription' && (
              <div>
                <label className="block text-xs text-gray-600 dark:text-gray-400 mb-1">Stripe Subscription ID</label>
            ...
            {(stripeForm.action === 'send_invoice' || stripeForm.action === 'create_payment_link') && (
              <div className="grid grid-cols-2 gap-3">
                ...
                {stripeForm.action === 'send_invoice' && (
                  <div>
                    <label className="block text-xs text-gray-600 dark:text-gray-400 mb-1">Due in (days)</label>
            ...
            {stripeForm.action === 'start_recurring' && (
              <div>
                <label className="block text-xs text-gray-600 dark:text-gray-400 mb-1">Stripe Price ID</label>
            ...
            {stripeForm.action === 'create_customer' && (
              <p className="text-xs text-gray-500 dark:text-gray-400">Creates a Stripe customer for <strong>{profile.email}</strong> and links it to this account.</p>
            )}
