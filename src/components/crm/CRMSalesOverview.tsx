    ...
    <section className="space-y-4">
      ...
      <div className="grid gap-4 xl:grid-cols-3">
        <div className="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-gray-900">
          <div className="mb-3 flex items-center justify-between gap-3">
            <h3 className="text-sm font-bold text-gray-900 dark:text-white">Top hot leads needing action</h3>
          ...
          <div className="space-y-2">
            ...
            {data.lists.top_hot_leads.map(lead => (
              <Link key={lead.id} href={`/admin/crm/${lead.id}`} className="block rounded-xl border border-gray-200 p-2.5 hover:border-green-300 dark:border-gray-800 dark:hover:border-green-700">
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-gray-900">
          <div className="mb-3 flex items-center justify-between gap-3">
            <h3 className="text-sm font-bold text-gray-900 dark:text-white">Scheduled callbacks</h3>
          ...
          <div className="space-y-2">
            ...
            {data.lists.scheduled_callbacks.map(task => (
              <div key={task.id} className="rounded-xl border border-gray-200 p-2.5 dark:border-gray-800">
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-gray-900">
          <div className="mb-3 flex items-center justify-between gap-3">
            <h3 className="text-sm font-bold text-gray-900 dark:text-white">Overdue follow-up</h3>
          ...
          <div className="space-y-2">
            ...
            {data.lists.overdue_tasks.map(task => (
              <div key={task.id} className="rounded-xl border border-red-200 bg-red-50 p-2.5 dark:border-red-900 dark:bg-red-950/20">
      ...
      {!compact && (
        <div className="grid gap-4 xl:grid-cols-2">
          <div className="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-gray-900">
            <h3 className="text-base font-bold text-gray-900 dark:text-white">Conversion by source</h3>
            <p className="mb-3 text-sm text-gray-500">Measure which lead channels are actually producing revenue.</p>
            <SimpleBars items={data.charts.conversion_by_source.map(item => ({ label: `${item.label} (${item.rate}%)`, value: item.won }))} color="bg-blue-500" />
          </div>
          <div className="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-gray-900">
            <h3 className="text-base font-bold text-gray-900 dark:text-white">Conversion by agent</h3>
            <p className="mb-3 text-sm text-gray-500">Multi-user visibility is ready if more closers are added.</p>
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-gray-900">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-base font-bold text-gray-900 dark:text-white">Priority sales board</h3>
        </div>
        <div className="mt-3 grid gap-2 md:grid-cols-2 xl:grid-cols-4">
          <Link href="/admin/crm?temperature=hot" className="rounded-xl border border-gray-200 p-3 hover:border-green-300 dark:border-gray-800 dark:hover:border-green-700">
          ...
          <Link href="/admin/crm/tasks?bucket=today" className="rounded-xl border border-gray-200 p-3 hover:border-green-300 dark:border-gray-800 dark:hover:border-green-700">
          ...
          <Link href="/admin/crm/tasks?bucket=overdue" className="rounded-xl border border-gray-200 p-3 hover:border-green-300 dark:border-gray-800 dark:hover:border-green-700">
            <p className="text-xs font-semibold text-gray-900 dark:text-white">Overdue follow-up</p>
            <p className="mt-1 text-xl font-bold text-red-600">{data.lists.overdue_tasks.length}</p>
          </Link>
          <Link href="/admin/crm?open_tasks=true" className="rounded-xl border border-gray-200 p-3 hover:border-green-300 dark:border-gray-800 dark:hover:border-green-700">
