...
export async function applyMembershipChange(
  ...
  await logPortalEvent({
    ...
    metadata: {
      ...
      previous_feature_tier: profile?.feature_tier ?? null,
      previous_billing_status: profile?.billing_status ?? null,
      previous_assigned_program: profile?.assigned_program ?? null,
      new_feature_tier: profileUpdate.feature_tier,
      new_billing_status: profileUpdate.billing_status,
