-- ============================================================
-- CRM Sales Workspace
-- Adds structured calls, tasks, callbacks, and richer lead fields
-- ============================================================
...
CREATE INDEX IF NOT EXISTS crm_leads_temperature_idx ON public.crm_leads (lead_temperature);
CREATE INDEX IF NOT EXISTS crm_leads_callback_due_idx ON public.crm_leads (callback_due_at);
CREATE INDEX IF NOT EXISTS crm_leads_last_call_idx ON public.crm_leads (last_call_at desc);
CREATE INDEX IF NOT EXISTS crm_leads_assigned_to_idx ON public.crm_leads (assigned_to_user_id);
