-- ============================================================
-- Fix dialer promotion visibility
-- Ensure promoted CRM leads are unarchived and visible in Sales CRM
-- even when promotion merges into an existing archived record.
-- ============================================================
...
BEGIN
  ...
  ELSE
    INSERT INTO public.crm_leads (
      ...
      business_name, notes, source, stage, is_archived
    ) VALUES (
      p_first_name, p_last_name, p_phone, p_phone_e164, p_email,
      p_business_name, p_notes, v_source, 'contacted', false
    )
